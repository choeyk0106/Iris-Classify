...
if __name__ == "__main__":
	...
	confusionMatrix2f[0] = plotClassifyTestData(setosa2fTestData, versicolor2fTestData, virginica2fTestData, setosa2fGList, versicolor2fGList, virginica2fGList, 0)
	confusionMatrix2f[1] = plotClassifyTestData(setosa2fTestData, versicolor2fTestData, virginica2fTestData, setosa2fGList, versicolor2fGList, virginica2fGList, 1)
	confusionMatrix2f[2] = plotClassifyTestData(setosa2fTestData, versicolor2fTestData, virginica2fTestData, setosa2fGList, versicolor2fGList, virginica2fGList, 2)
